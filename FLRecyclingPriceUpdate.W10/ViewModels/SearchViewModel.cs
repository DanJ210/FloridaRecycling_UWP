...
namespace FLRecyclingPriceUpdate.ViewModels
{
    public class SearchViewModel : PageViewModelBase
    {
        ...
        {
			Title = "FLRecycling Price Update";
            CommodityPrices = ViewModelFactory.NewList(new CommodityPricesSection());
            Policy = ViewModelFactory.NewList(new PolicySection());
        ...
        public ListViewModel CommodityPrices { get; private set; }
        public ListViewModel Policy { get; private set; }
